...
@Component({
  selector: 'app-change-system',
  templateUrl: './change-system.component.html',
  styleUrls: ['./change-system.component.scss']
})
 export class ChangeSystemComponent { public numClass: number = 1;
  ...
  public showSystem(item: string) {
    this.system.GetChangeTimeForClass(item).subscribe(
      res => {
        console.log(res);
